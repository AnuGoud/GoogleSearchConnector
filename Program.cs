...
using GoogleDriveSearchConnector.Authentication;
using GoogleDriveSearchConnector.Console;
using GoogleDriveSearchConnector.Data;
using GoogleDriveSearchConnector.Graph;
...
namespace GoogleDriveSearchConnector
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                Output.WriteLine("Google Drive Search Connector\n");
                ...
                do
                {
                    ...
                    switch (userChoice)
                    {
                        ...
                        case MenuChoice.PushItems:
                            UploadItemsFromCsvAsync("MyDriveFiles.csv").Wait();
                            break;
        ...
        private static async Task RegisterSchemaAsync()
        {
            ...
            try
            {
                ...
                var schema = new Schema
                {
                    ...
                    {
                        new Property { Name = "RowID", Type = Property.IntProperty, IsQueryable = false, IsSearchable = false, IsRetrievable = true },
                        //new Property { Name = "FileID", Type = Property.StringProperty, IsQueryable = false, IsSearchable = false, IsRetrievable = true },
                        new Property { Name = "FileName", Type = Property.StringProperty, IsQueryable = true, IsSearchable = true, IsRetrievable = true },
                        new Property { Name = "Owner", Type = Property.StringProperty, IsQueryable = true, IsSearchable = true, IsRetrievable = true },
                        //new Property { Name = "OwnerEmail", Type = Property.StringProperty, IsQueryable = true, IsSearchable = true, IsRetrievable = true },
                        new Property { Name = "LastModifyingUser", Type = Property.StringProperty, IsQueryable = true, IsSearchable = true, IsRetrievable = true },
                        //new Property { Name = "LastModifyingUserEmail", Type = Property.StringProperty, IsQueryable = true, IsSearchable = true, IsRetrievable = true },
                        //new Property { Name = "ModifiedTime", Type = Property.DateTimeProperty, IsQueryable = true, IsSearchable = false, IsRetrievable = true },
                        //new Property { Name = "CreatedTime", Type = Property.DateTimeProperty, IsQueryable = true, IsSearchable = false, IsRetrievable = true },
                        //new Property { Name = "Size", Type = Property.StringProperty, IsQueryable = false, IsSearchable = false, IsRetrievable = true },
                        //new Property { Name = "FilePath", Type = Property.StringProperty, IsQueryable = true, IsSearchable = true, IsRetrievable = true },
                    }
                };
